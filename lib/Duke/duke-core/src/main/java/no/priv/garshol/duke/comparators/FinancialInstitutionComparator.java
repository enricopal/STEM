...
public class FinancialInstitutionComparator implements Comparator {
  ...
  public static double similarity(String s1, String s2) {
   ...
   //check if the keyword "bank" is in one string and not in the other, then the similarity will be 0

    String[] keywords = {"bank"};
