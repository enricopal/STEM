...
import subprocess
import optparse
from duke_output_parser import duke_output_parser
...
f = open('results_stacking_T2_n%d.csv' %N, 'w')
...
#print "The union result is:\n"
#scorer('ensemble_duke_output_union_T2_n%d.txt' %N, gold_standard_name)

#print "The stacking scoring is:\n"
#scorer('results_stacking_T2_n%d.csv'%N,gold_standard_name)
